...
#define STRINGIFY_MAT_H( X, Y ) DebugStr stringify( Mat##X##x##Y m );
...
#define MULT_TRANSP_H( X, Y ) Mat##Y##x##X transpose_m( Mat##X##x##Y m );
...
Mat4x4 translate_mat( Mat4x4 m, Vec3f v );

Mat4x4 scale_mat( Mat4x4 m, Vec3f v );
